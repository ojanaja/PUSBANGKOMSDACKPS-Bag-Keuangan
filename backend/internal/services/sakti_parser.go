...
// SaktiRow represents a parsed row from a SAKTI report CSV/Excel.
type SaktiRow struct {
	ProgramKode     string
...
// ParseSaktiCSV reads a SAKTI report CSV and returns structured rows.
...
func ParseSaktiCSV(r io.Reader) ([]SaktiRow, error) {
