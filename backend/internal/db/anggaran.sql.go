...
type GetAnggaranDokumenByIDRow struct {
...
func (q *Queries) GetAnggaranDokumenByID(ctx context.Context, id pgtype.UUID) (GetAnggaranDokumenByIDRow, error) {
	row := q.db.QueryRow(ctx, getAnggaranDokumenByID, id)
	var i GetAnggaranDokumenByIDRow
	err := row.Scan(
		&i.ID,
		&i.AnggaranNodeID,
		&i.FileHashSha256,
...
type InsertAnggaranDokumenRow struct {
	ID             pgtype.UUID        `json:"id"`
	AnggaranNodeID pgtype.UUID        `json:"anggaran_node_id"`
	FileHashSha256 string             `json:"file_hash_sha256"`
	OriginalName   string             `json:"original_name"`
...
func (q *Queries) InsertAnggaranDokumen(ctx context.Context, arg InsertAnggaranDokumenParams) (InsertAnggaranDokumenRow, error) {
	...
	var i InsertAnggaranDokumenRow
	err := row.Scan(
		&i.ID,
		&i.AnggaranNodeID,
		&i.FileHashSha256,
...
type UpdateAnggaranDokumenNameRow struct {
	ID             pgtype.UUID        `json:"id"`
	AnggaranNodeID pgtype.UUID        `json:"anggaran_node_id"`
	FileHashSha256 string             `json:"file_hash_sha256"`
	OriginalName   string             `json:"original_name"`
...
func (q *Queries) UpdateAnggaranDokumenName(ctx context.Context, arg UpdateAnggaranDokumenNameParams) (UpdateAnggaranDokumenNameRow, error) {
	row := q.db.QueryRow(ctx, updateAnggaranDokumenName, arg.OriginalName, arg.ID)
	var i UpdateAnggaranDokumenNameRow
	err := row.Scan(
		&i.ID,
		&i.AnggaranNodeID,
		&i.FileHashSha256,
